...
def main():
    ...
    steps = [
        ("1. Compute grayscale mean/std", [python, str(CHALLENGE_DIR / "01_compute_grayscale_mean_std.py")]),
        ("2. Audit transforms", [python, str(CHALLENGE_DIR / "02_audit_transforms.py")]),
        ("3. Train grayscale-norm (effnet_ts + per_day, days 13 & 15)", [python, str(CHALLENGE_DIR / "run_1_grayscale_norm.py")]),
        ("4. Train filled-mask (effnet_ts + per_day, days 13 & 15)", [python, str(CHALLENGE_DIR / "run_4_filled_mask.py")]),
    ]
    ...
    print("Outputs: runs_grayscale_norm/, runs_filled_mask/, audit_transforms_summary.json, grayscale_mean_std_*.npy")
    print("="*60)
