...
- **Splits**: `data/2026_winter_student_splits.csv` (organoid-level, seed=42). Regenerated by `analysis.paper_2026_04.generate_splits`; current data yields 201 organoids (≈144 train / 16 val / 41 test).
