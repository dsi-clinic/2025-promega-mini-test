...
METABOLITE_DATA_DIR = optional_env_path("METABOLITE_DATA_DIR") or (
    BASE_PATH / "metabolite_data"
)
METABOLITE_SOURCE_XLSX = optional_env_path("METABOLITE_SOURCE_XLSX") or (
    METABOLITE_DATA_DIR / "metabolite_data_07_23_25.xlsx"
)
METABOLITE_MAP_JSON = optional_env_path("METABOLITE_MAP_JSON") or (
    METABOLITE_DATA_DIR / "metabolite_map.json"
)
SURVEY_AGGREGATED_JSON = optional_env_path("SURVEY_AGGREGATED_JSON") or (
    SURVEY_RESULTS / "organoid_surveys_aggregated.json"
)
