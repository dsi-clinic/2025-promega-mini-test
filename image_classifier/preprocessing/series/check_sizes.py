...
def check_dimensions(data, series_metadata, sample_size=50):
    ...
    final_scales_x = [
        e["final_um_per_px_x"] for e in scale_data if e["final_um_per_px_x"] is not None
    ]
    final_scales_y = [
        e["final_um_per_px_y"] for e in scale_data if e["final_um_per_px_y"] is not None
    ]
    ...
    orig_scales_x = [
        e["orig_um_per_px_x"] for e in scale_data if e["orig_um_per_px_x"] is not None
    ]
