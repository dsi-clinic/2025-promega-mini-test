custom_imports = dict(
    imports=["mmseg.models.losses", "mmseg.datasets.transforms"],
...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=[
            ...
            1024,
            2048,
        ],  # These must match ResNet-50 output channels
        in_index=[0, 1, 2, 3],
        pool_scales=(1, 2, 3, 6),
        channels=128,
        dropout_ratio=0.15,
...
param_scheduler = [
    ...
    dict(type="PolyLR", power=0.9, eta_min=0.0, begin=100, end=1000, by_epoch=False),
]
