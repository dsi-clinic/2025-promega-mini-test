...
from analysis.images.cnn_lstm.train_organoid_lstm_single_phase import (
    train_one_epoch, evaluate, set_seed, collate_variable_length
)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Train CNN-LSTM with our data split (Amanda\'s original model)')
