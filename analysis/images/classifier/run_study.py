...
Usage:
    make run ARGS="-m analysis.images.classifier.run_study"
    make run ARGS="-m analysis.images.classifier.run_study --days Dy30"
    make run ARGS="-m analysis.images.classifier.run_study --input-mode img"
"""
